...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        _infoImage = [UIImage imageNamed:@"/Library/Application Support/BH/Ressources.bundle/SVProgressHUD.bundle/info"]; //[UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"info" ofType:@"png"]];
        _successImage = [UIImage imageNamed:@"/Library/Application Support/BH/Ressources.bundle/SVProgressHUD.bundle/success"]; //[UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"success" ofType:@"png"]];
        _errorImage = [UIImage imageNamed:@"/Library/Application Support/BH/Ressources.bundle/SVProgressHUD.bundle/error"]; //[UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"error" ofType:@"png"]];
